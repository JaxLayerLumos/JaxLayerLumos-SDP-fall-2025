...
NUM_INITIAL_POINTS = 10  # Random exploration before GP kicks in
NUM_GP_ITERATIONS = 100   # GP-guided optimization iterations
...
for run_idx in range(NUM_RUNS):
    ...
    def objective(**params):
        ...
        try:
            ...
            return float(peak_reflection_db)
...
for i in range(len(pareto_ref)):
    ...
    try:
        for iteration in range(10):
            ...
            refined_ref[i] = float(reflection_for_grad(refined_layer_thick[i], pareto_mats[i]))
